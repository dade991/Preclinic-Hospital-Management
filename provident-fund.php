...
<head>
    ...
    <title>Hospital Management System - Provident Fund</title>
                    ...
                    <ul>
						...
						<li class="submenu">
							...
							<ul style="display: none;">
								...
								<li><a class="active" href="provident-fund.php">Provident Fund</a></li>
							</ul>
						</li>
						<li class="submenu">
            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-7 col-8 text-right m-b-30">
                        <a href="add-provident-fund.php" class="btn btn-primary btn-rounded"><i class="fa fa-plus"></i> Add Provident Fund</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="edit-provident-fund.php"><i class="fa fa-pencil m-r-5"></i> Edit</a>
