...
<head>
    ...
    <title>Hospital Management System - Incoming Call</title>
                                ...
                                <div class="chat-content-wrap">
                                    ...
                                    <div class="call-users">
                                        <ul>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img src="assets/img/user-05.jpg" class="img-fluid" alt="">
                                                    <span class="call-mute"><i class="fa fa-microphone-slash"></i></span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#">
                                                    <img src="assets/img/user-06.jpg" class="img-fluid" alt="">
                                                    <span class="call-mute"><i class="fa fa-microphone-slash"></i></span>
                                                </a>
                                            </li>
                                        </ul>
                ...
                <div class="modal-body">
                    <div class="profile-widget">
                        <div class="profile-img">
                            <a href="profile.php" class="avatar"><img src="assets/img/user-03.jpg" alt=""></a>
                        </div>
                        <h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="profile.php">Tressa Wexler</a></h4>
                        <div class="small text-muted">calling ...</div>
                        <div class="incoming-btns">
                            <a href="chat.php" class="btn btn-success m-r-10">Decline</a>
                            <a href="profile.php" class="btn btn-danger">Answer</a>
                        </div>
                    </div>
                </div>
            </div>
