...
<head>
    ...
    <title>Hospital Management System - Assets</title>
            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-4 col-6 text-right m-b-30">
                        <a href="add-asset.php" class="btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Asset</a>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="edit-asset.php"><i class="fa fa-pencil m-r-5"></i> Edit</a>
